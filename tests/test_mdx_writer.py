from folio.generator import mdx_writer
from folio.generator.mdx_writer import _sanitize_for_mdx, markdown_to_mdx, module_to_mdx
...
def test_mdx_comment_survives_curly_escaping():
    ...
    """
    from folio.generator.mdx_writer import _sanitize_for_mdx
