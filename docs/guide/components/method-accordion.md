...
Expandable accordion panels for documenting class methods. Each method shows its name and signature in the header, with the full description revealed on click. Async methods display an "async" badge. Generated API pages do not write this component, since they give each method a heading of its own; use it by hand in the pages you write.
