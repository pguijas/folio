...
Folio's RST converter handles common directives during migration. Use the converted
Markdown/MDX output as your source documentation. Here is what the converter supports:
...
Treat the converter as a helper for common `.rst` pages, then review the generated
Markdown by hand.
