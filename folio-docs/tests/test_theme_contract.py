...
def test_codegen_matches_committed_file():
    ...
    if committed_path.exists():
        ...
        assert generated == committed, (
            "Generated TypeScript contract does not match committed file. Run: python -c 'from folio_docs.docs.theme_contract_codegen import generate_typescript_contract; from pathlib import Path; Path(\"template/theme/theme-contract.generated.ts\").write_text(generate_typescript_contract())'"
        )
