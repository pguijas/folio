...
from folio_docs._github_pages import (
    COMMENT_MARKER,
...
def test_compute_preview_path_normalizes_branch_and_base_path() -> None:
    ...
    assert preview.url == "https://pguijas.github.io/folio/previews/pr-17-feature-foo/"
...
def test_upsert_preview_comment_updates_existing_comment(monkeypatch) -> None:
    ...
    monkeypatch.setattr("folio_docs._github_pages.subprocess.run", fake_run)
