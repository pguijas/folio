...
from folio_docs.build import _apply_extensions, build_registry
from folio_docs.config import Config
from folio_docs.docs.site_builder import SiteBuilder
from folio_docs.plugin import PluginDocument, PluginHookError, PluginManager, hookimpl
...
def test_empty_project_gate_counts_plugin_views(tmp_path: Path) -> None:
    ...
    """
    from folio_docs.build import _parse_project_sources
