...
<CardGrid columns={2}>
  ...
  <FeatureCard
    ...
    description="Roadmap and landing are default plugins activated by one key. OpenAPI and third-party integrations are opt-in."
    icon="workflow"
    href="/docs/plugins/index"
  />
  <FeatureCard
    title="Sphinx migration"
    description="A migration guide for converting existing RST pages and Sphinx conventions into Folio's Markdown and MDX inputs."
    icon="git"
    href="/docs/migration"
  />
</CardGrid>
