...
<CommandGrid>
  ...
  <CommandCard command="folio board" title="Board" description="Operate the repository-native Agents board when Folio for Agents is installed." flags={["--project-dir", "--config"]} href="#folio-board" />
</CommandGrid>
...
[Folio for Agents CLI reference](https://github.com/pguijas/folio/blob/main/folio-agents/docs/agents/board/cli.md).
