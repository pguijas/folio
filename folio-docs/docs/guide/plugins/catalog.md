...
<CardGrid columns={2}>
  <FeatureCard
    title="OpenAPI"
    description="Add folio_docs.docs.integrations.openapi to plugins:, point openapi.sources at a spec file, and get a typed API reference page wired into the sidebar and search."
    icon="api"
