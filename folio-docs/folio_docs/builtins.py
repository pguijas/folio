...
:class:`~folio_docs.extensions.ExtensionRegistry` so that the registry is the
authoritative description of every component Folio exposes. The MDX contract
(:mod:`folio_docs.agent_output.contract`) and the build-time component injection
...
BUILTIN_COMPONENTS: tuple[ComponentDefinition, ...] = (
    ...
    _component(
        ...
        props={"type": "string", "href": "string | undefined"},
    ),
    _component(
        "MethodAccordion",
        "method-accordion",
        ...
        props={
            "methods": (
                ...
                "description: string; isAsync?: boolean; "
    ...
    _component(
        ...
        contract=True,
        source_label="component-catalog",
        props={"columns": "2 | 3 | 4 | undefined", "children": "React.ReactNode"},
    ),
    _component(
        "Tabs",
        "tabs",
