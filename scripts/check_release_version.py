...
def main() -> None:
    ...
    docs_config = yaml.safe_load((ROOT / "docs.yaml").read_text(encoding="utf-8"))
    ...
    if folio.__version__ != version:
        _fail(f"folio.__version__ is {folio.__version__}, expected {version}")
