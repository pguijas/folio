...
class Config:
    ...
    # (folio/plugins/landing.py): its configure() hook parses the `landing:`
...
def resolve_theme_package_path(
    ...
    Delegates to :func:`folio.paths.resolve_contained_dir` (the same guard used
    ...
    is not required here because ``folio.build`` validates it later.
    """
