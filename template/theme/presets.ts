...
const baseStyle: ThemeStyle = {
  ...
  "--code-shadow": "none",
  "--h2-border": "1px solid var(--border)",
  "--h2-transform": "none",
  "--h2-letter-spacing": "0",
  "--h2-weight": "800",
  "--h2-padding-left": "0",
  ...
  "--workspace-shell-padding": "0px",
  "--workspace-shell-border": "0 solid transparent",
  "--workspace-shell-shadow": "none",
  "--workspace-shell-background": "var(--background)",
  "--workspace-shell-surface": "transparent",
  "--workspace-shell-topbar": "var(--background)",
}
...
const folioBinding = {
  ...
  case: {
    ...
    style: makeStyle({
      "--heading-weight": "850",
      "--card-hover-shadow": "0 6px 18px oklch(0.155 0.007 82 / 0.08)",
      "--card-padding": "1.5rem",
      "--section-gap": "2.75rem",
      "--content-max-width": "48rem",
    }),
  ...
  reference: {
    ...
    style: makeStyle({
      ...
      "--card-shadow": "0 14px 40px -34px oklch(0.180 0.006 160 / 0.28)",
      "--card-border-width": "1px",
      "--card-padding": "1rem",
      "--card-hover-shadow": "0 18px 54px -42px oklch(0.180 0.006 160 / 0.38)",
      "--h2-border": "none",
      "--h2-transform": "none",
      "--h2-weight": "700",
...
const folioCode = {
  ...
  plate: {
    "--code-bg": "var(--card)",
    "--code-foreground": "inherit",
    "--code-border": "1.5px solid var(--foreground)",
    "--code-border-radius": "0",
  },
  panel: {
    "--code-bg": "var(--muted)",
...
function resolveLedger(options: PresetOptionValues): ResolvedPresetTheme {
  ...
  return {
    ...
    radius: "0.2rem",
    style: makeStyle({
      "--body-line-height": density.lineHeight,
      "--font-size-base": density.fontSize,
      "--card-border-width": rule.border,
      "--card-padding": density.padding,
      "--h2-border": rule.h2,
      "--section-gap": density.sectionGap,
      "--content-max-width": density.width,
...
function resolvePress(options: PresetOptionValues): ResolvedPresetTheme {
  ...
  return {
    ...
    radius: "0",
    style: makeStyle({
      "--heading-weight": impression.weight,
      "--card-border-width": impression.border,
      "--card-padding": "1.2rem",
      "--code-border-radius": impression.code,
      "--code-border": `${impression.border} solid var(--foreground)`,
      "--h2-border": `${impression.border} solid var(--foreground)`,
      "--h2-transform": "uppercase",
      "--h2-weight": impression.weight,
      "--section-gap": "2.6rem",
...
function resolveArchive(options: PresetOptionValues): ResolvedPresetTheme {
  ...
  return {
    ...
    style: makeStyle({
      "--heading-weight": "760",
      "--body-line-height": reading.lineHeight,
      "--card-padding": "1.45rem",
      "--code-border-radius": "0.35rem",
      "--section-gap": reading.gap,
      "--content-max-width": reading.width,
    }),
    light: makeVars({
...
function resolveCarbon(options: PresetOptionValues): ResolvedPresetTheme {
  ...
  const code = choose(
    {
      block: {
        "--code-bg": "color-mix(in oklch, var(--muted) 86%, var(--background))",
        "--code-foreground": "inherit",
        "--code-border": "1.5px solid color-mix(in oklch, var(--border) 72%, var(--background))",
      },
      outline: {
  ...
  return {
    ...
    style: makeStyle({
      ...
      "--card-border-width": "1.5px",
      "--card-padding": "1.25rem",
      "--card-hover-shadow": "3px 3px 0 0 var(--foreground)",
      "--code-border-radius": "0",
      "--h2-transform": "uppercase",
      "--h2-weight": "900",
      "--section-gap": "2.5rem",
...
function resolveBeacon(options: PresetOptionValues): ResolvedPresetTheme {
  ...
  return {
    ...
    style: makeStyle({
      "--heading-font-family": "var(--font-sans), ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, \"Segoe UI\", sans-serif",
      "--body-font-family": "var(--font-sans), ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, \"Segoe UI\", sans-serif",
      "--heading-weight": density.headingWeight,
      "--body-line-height": density.lineHeight,
      "--font-size-base": density.fontSize,
      "--card-shadow": "0 18px 60px -44px oklch(0.175 0.014 254 / 0.45)",
      "--card-border-width": "1px",
      "--card-padding": density.padding,
      "--card-hover-shadow": "0 20px 64px -44px oklch(0.175 0.014 254 / 0.55)",
      "--h2-border": "1px solid var(--border)",
      "--h2-transform": "uppercase",
      "--h2-weight": density.h2Weight,
      "--link-decoration": "none",
      "--section-gap": density.sectionGap,
      "--content-max-width": density.width,
      ...code,
...
const sourceWorkspaceCode = {
  panel: {
    "--code-bg": "color-mix(in oklch, var(--muted) 88%, var(--background))",
    "--code-foreground": "inherit",
  ...
  window: {
    ...
    "--code-foreground": "inherit",
    "--code-border-radius": "0.7rem",
    "--code-shadow": "0 18px 48px -38px oklch(0.155 0.007 82 / 0.42)",
  },
  plate: {
    "--code-bg": "var(--background)",
    "--code-foreground": "inherit",
...
function resolveSourceWorkspace(options: PresetOptionValues): ResolvedPresetTheme {
  ...
  return {
    ...
    style: makeStyle({
      ...
      "--body-line-height": density.lineHeight,
      "--font-size-base": density.fontSize,
      "--card-shadow": frame.cardShadow,
      "--card-border-width": frame.cardBorder,
      "--card-padding": density.padding,
      "--card-hover-shadow": frame.cardHoverShadow,
      "--code-border": frame.codeBorder,
      "--h2-border": frame.h2Border,
      "--h2-transform": "none",
      "--h2-weight": density.h2Weight,
      "--link-decoration": "none",
      "--section-gap": density.sectionGap,
      ...
      "--workspace-shell-border": frame.shellBorder,
      "--workspace-shell-shadow": frame.shellShadow,
      "--workspace-shell-background": "color-mix(in oklch, var(--muted) 42%, var(--background))",
      "--workspace-shell-surface": "color-mix(in oklch, var(--card) 96%, var(--background))",
      "--workspace-shell-topbar": "color-mix(in oklch, var(--muted) 66%, var(--background))",
      ...code,
    }),
    light: makeVars(surface.light),
    dark: makeVars(surface.dark),
...
const organicEditorialCode = {
  ...
  gallery: {
    "--code-bg": "var(--background)",
    "--code-foreground": "inherit",
    "--code-border": "1px solid var(--foreground)",
    "--code-border-radius": "0.25rem",
  },
} satisfies Record<string, Partial<ThemeStyle>>
...
function resolveOrganicEditorial(options: PresetOptionValues): ResolvedPresetTheme {
  ...
  return {
    ...
    style: makeStyle({
      "--heading-font-family": "var(--font-sans), ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, \"Segoe UI\", sans-serif",
      "--body-font-family": "var(--font-sans), ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, \"Segoe UI\", sans-serif",
      "--heading-weight": scale.headingWeight,
      "--body-line-height": scale.lineHeight,
      "--font-size-base": scale.fontSize,
      "--card-shadow": "none",
      "--card-border-width": "1px",
      "--card-padding": scale.padding,
      "--card-hover-shadow": "0 0 0 1px var(--foreground)",
      "--h2-border": "none",
      "--h2-transform": "uppercase",
      "--h2-weight": scale.h2Weight,
      "--h2-letter-spacing": "0",
      "--link-decoration": "none",
      "--section-gap": scale.sectionGap,
      "--content-max-width": scale.width,
      ...code,
    }),
    light: makeVars({
