...
const componentGroups: ComponentGroup[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      {
        title: "OrganicEditorialImagePrompt",
        description:
          "Prompt card for generating Organic Editorial abstract hero images.",
        href: "/docs/components/organic-editorial-image-prompt",
        role: "Image",
      },
      {
        title: "Mermaid",
...
function groupStyle(accent: string) {
  return { "--component-group-accent": accent } as CSSProperties
}
