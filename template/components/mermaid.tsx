...
/* The Mermaid theme, read from the page's tokens when a diagram renders, so
   a diagram follows the preset like every other surface. The fallbacks
   answer only when a token does not resolve. */
export function mermaidThemeConfig(isDark: boolean): MermaidConfig {
...
/* The MDX-level escapes a chart source carries through the compiled page. */
export { escapeHtml as mermaidEscapeHtml, unescapeHtml as mermaidUnescapeHtml }
