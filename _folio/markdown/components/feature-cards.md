...
- **[Auto API Reference](/docs/docstrings)**: Extracts documentation from your source code automatically.

- **Modern UI**: Dark mode, search, and responsive layout out of the box.

- **[LLM Output](/docs/configuration#llm)**: Generate llms.txt and llms-full.txt for AI assistants.
