...
The equivalent decision for frontend code is documented in [Theme Packages](/docs/theming/theme-packages) and [Custom Templates](/docs/theming/custom-templates).
